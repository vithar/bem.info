...
(function (global) {
    var __i18n__ = ((function () {
            ...
            return i18n;
        })()).decl({"header":{"forum":"Forum"},"article-amendments":{"text":"If you notice a mistake or want something to supplement the article, you can always write to us at ","issue":"GitHub","edit":", or correct an article using "},"social-likes":{"text":"Share with world"},"bem":{"bem":"BEM"}}),
        defineAsGlobal = true;
